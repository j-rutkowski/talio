...
*The items below are things you should look into after the first meeting. During the meeting you can divide (some of) the work between the team members, so that everybody has something to do afterwards.*
 ...
 - Create a planning and put it on GitLab
	 - Implement all items on the todo cardList
...
*Every week you fill the Scrum board with new action points for that week. See the to do cardList for the items you should implement.*
